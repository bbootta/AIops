...
(function (NS) {
  ...
  var DORSUM = [
    ...
    [388, 484], [402, 472], [421, 484], [440, 494],
    [459, 468], [476, 454], [495, 470], [514, 496],
    [532, 476], [548, 468], [565, 486], [582, 520],
    [600, 514], [612, 510], [626, 528]
  ];
  ...
  var PROFILE = [
    ...
    [0.58, 1.015], [0.70, 0.995], [0.82, 0.985], [0.88, 0.965]
  ];
  ...
  function nailMetrics(fg, design) {
    var hw = fg.w1 * 0.80;             // 네일 반폭 (손가락 끝 폭의 약 80%)
