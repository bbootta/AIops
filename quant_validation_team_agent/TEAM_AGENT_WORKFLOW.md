...
| 2. 검증대상·리스크영역 분류 | Intake 완료 | 5개 초기 분기와 리스크 산출 영역을 2축으로 분류 | 분류 근거와 불확실성 기록 | `validation_object_type`, `primary_risk_output_domain`, `secondary_risk_output_domains`, `classification_rationale` | 유형 또는 리스크 영역 분류 불가 |
