...
|---|---|---|---|---|---|---|---|---|
| SAMPLE-CREDIT-001 | 45994b1b32db | credit_risk | credit_risk_parameter | Green | 중대 이슈 미발견 게이트 | False | None | - |
| SAMPLE-RATING-001 | 2152b3b637ae | credit_risk | credit_rating_model | Green | 중대 이슈 미발견 게이트 | False | None | - |
| SAMPLE-MARKET-001 | cc90fd94b2a5 | market_risk | hybrid_risk_output | Yellow | 보완 가능 이슈 게이트 | True | None | - |
...
| SAMPLE-IRRBB-001 | c881c40cb726 | interest_rate_risk | hybrid_risk_output | Green | 중대 이슈 미발견 게이트 | False | None | - |
| SAMPLE-LIQ-001 | c0dff39198b2 | liquidity_risk | aggregation_reporting | Green | 중대 이슈 미발견 게이트 | False | None | - |
| SAMPLE-STRATEGIC-001 | 89d76e63b330 | strategic_risk | hybrid_risk_output | Gray | 데이터·증적 게이트 | True | EVIDENCE_INSUFFICIENT | management_approval_signature |
| SAMPLE-REPUTATION-001 | f4fe4446068d | reputational_risk | risk_factor_validation | Gray | 공식 기준 게이트 | True | POLICY_UNDEFINED | approved_event_taxonomy, external_data_usage_permission, deduplication_rule_evidence |
| SAMPLE-CAPITAL-001 | e383711c77a7 | capital_adequacy_aggregation | aggregation_reporting | Yellow | 보완 가능 이슈 게이트 | True | None | - |
| SAMPLE-MULTI-001 | e9c54fd775ad | multi_risk_or_unclear | hybrid_risk_output | Gray | 리스크 영역 게이트 | True | EVIDENCE_INSUFFICIENT | primary_owner, policy_reference, calculation_engine_result_reference, cross_risk_lineage |
