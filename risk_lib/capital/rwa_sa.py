...
# 기업 표의 절단점은 국가·은행과 다르다. 국가·은행은 B- 미만이 150% 라
# "B" 가 100% 지만, 기업은 CRE20.34 에서 BB- 미만이 150% 라 "B" 가 150% 다.
# 세 표에 같은 어휘를 복사하며 이 차이가 지워져 기업 B 등급이 100% 로
# 남아 있었고, 신용 SA RWA 와 산출하한 분모가 함께 과소계상됐다.
_RW_CORPORATE = {
    "AAA-AA": 0.20,
    "A": 0.50,
    "BBB": 0.75,
