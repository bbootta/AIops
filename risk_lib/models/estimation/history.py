...
# 경기 국면 배수. 합이 정확히 연수와 같아 평균이 1.0이고, 마지막 해(사후검증
# 유보연도)도 1.0이라 추정 표본 7년의 평균 역시 1.0이다. 그래야 연도동일가중
# 단순평균이 기저 부도율을 되찾고, 사후검증 대상연도가 평년이 된다. 침체기가
# 표본에 없으면 185.의 경기침체 LGD를 추정할 수 없으므로 두 해를 침체로 넣는다.
_CYCLE_MULT: tuple[float, ...] = (0.8, 0.9, 1.0, 1.6, 1.3, 0.8, 0.6, 1.0)
