...
COVERAGE: dict[str, Coverage] = {
    ...
    "SEC-PRC-001": _C("covered", "risk_lib.market_data (스냅샷·소스·staleness·지문)",
                      "ops/67_market_data"),
    "SEC-PRC-002": _C("partial", "risk_lib.sensitivities",
                      "ops/54_trading_sensitivities",
                      "Black-Scholes 계열 Greeks 구현, 상품명세 원장·엔진 버전관리는 미구현"),
    "SEC-PRC-003": _C("partial", "risk_lib.sensitivities · risk_lib.ipv",
                      "ops/54_trading_sensitivities · ops/66_ipv",
                      "Greeks 산출과 가격차이 회귀검증(허용오차 기반 BREAK 판정)은 구현, "
                      "엔진 버전 간 회귀테스트 harness는 미구현"),
    "SEC-PRC-004": _C("covered", "risk_lib.market_data (부트스트랩·변동성면 적합·무차익)",
                      "ops/67_market_data"),
    "SEC-PRC-005": _C("covered", "risk_lib.ipv (소스 위계·MR-F003 판정·평가조정·aging)",
                      "ops/66_ipv"),
    ...
    "GOV-006": _C("covered", "risk_lib.frtb · sensitivities · risk_lib.ipv",
                  "ops/56_frtb_ima · ops/54_trading_sensitivities · ops/66_ipv"),
    ...
    "RDM-007": _C("partial", "risk_lib.notifications · risk_lib.adjustments",
                  "ops/25_data_quality · ops/65_manual_adjustments",
                  "예외 경보와 조정 승인·차단 통제는 구현, 티켓 시스템 연계는 플랫폼 계층"),
    ...
    "DAT-005": _C("covered", "risk_lib.data_quality",
                  "ops/25_data_quality"),
    "DAT-006": _C("covered", "risk_lib.adjustments (SoD·중요성·유효기간·증빙 통제 + 지문)",
                  "ops/65_manual_adjustments"),
