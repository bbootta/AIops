...
본 문서는 차세대 업그레이드 리팩토링 계획서다. 결정 항목 Q1~Q5 는 2026-06-10
사용자 확정 완료 (아래 표). 전체 Phase 는 R20~R33 에서 구현 완료됐다 —
Phase 1 (R20), Phase 4 (R21), Phase 2 (R27), Phase 3 (R28~R29),
목표 5 lint/type gate (R30), Q5 추가 기능 (R31~R33).
잔여 일정은 v1 호환 shim 제거 (2026-Q4, Q2 결정) 뿐이다.
