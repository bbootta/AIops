...
try:
    from vta.domains import (  # noqa: F401
        alm, capital, ccr, concentration, cva, icaap, irrbb, liquidity, market,
        operational,
    )
...
for _name, _mod in [
    ("alm", alm), ("capital", capital), ("concentration", concentration), ("ccr", ccr),
    ("cva", cva), ("icaap", icaap), ("irrbb", irrbb), ("liquidity", liquidity),
    ("market", market), ("operational", operational),
]:
